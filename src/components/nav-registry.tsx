...
// 导航注册表:侧栏 / 移动抽屉 / 移动底栏 / 权限管控共用的单一事实来源。
// 独立成模块以避免 Sidebar ↔ use-module-visibility 循环导入(TDZ 崩溃)。
export const I = (d: string): ReactNode => (
...
export const GROUPS: { label: string; items: { href: string; label: string; icon: ReactNode; ready: boolean }[] }[] = [
  ...
  { label: "资产", items: [
    ...
    { href: "/guide", label: "面试宝典", icon: I("M4 5a2 2 0 012-2h5v18H6a2 2 0 01-2-2zM13 3h5a2 2 0 012 2v14a2 2 0 01-2 2h-5zM8 7h1M8 11h1"), ready: true },
